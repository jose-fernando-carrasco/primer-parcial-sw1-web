...
<style>
        ...
        .navbar .dropdown-menu {
            padding: 0;
            background-color: rgba(71, 85, 186, 0.9);
        }
...
<header class="header-area overlay">
    <nav class="navbar navbar-expand-md navbar-dark">
		<div class="container">
			<a href="#" class="navbar-brand">Fotomania.com</a>
			
			{{-- <button type="button" class="navbar-toggler collapsed" data-toggle="collapse" data-target="#main-nav">
				<span class="menu-icon-bar">XD</span>
				<span class="menu-icon-bar">XD</span>
				<span class="menu-icon-bar">XD</span>
			</button> --}}
	...
	<div class="banner">
		<div class="container">
			<h1>Bienvenido a Fotomania</h1>
			<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec elit ex. Etiam elementum lectus et tempor molestie.</p>
			<a href="#content" class="button button-primary">Leer Politicas y licencias</a>
		</div>
	</div>
</header>

{{-- Parte en blanco con esas 3 columnas --}}
<main>
